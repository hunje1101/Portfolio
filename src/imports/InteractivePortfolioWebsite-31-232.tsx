...
function Link1() {
  return (
    <div className="h-px relative shrink-0 w-[155px]" data-name="Link">
      <div className="absolute inset-[0_0_-50%_0]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 155 1.5">
          <g id="Link">
            <path d="M0 1H154" id="Vector 1" stroke="var(--stroke-0, black)" />
          </g>
        </svg>
      </div>
    </div>
...
function Link4() {
  return (
    <div className="h-[22px] relative shrink-0 w-[155px]" data-name="Link">
      <div className="-translate-y-1/2 absolute flex flex-col font-['Switzer:Medium',sans-serif] justify-center leading-[0] left-0 not-italic text-[16px] text-black top-[11px] tracking-[-0.0762px] whitespace-nowrap">
        <p className="leading-[20.8px]">Something Fun</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="h-px relative shrink-0 w-[155px]" data-name="Link">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 155 1">
        <g id="Link">
          <path d="M0 0.5H154" id="Vector 2" stroke="var(--stroke-0, black)" />
        </g>
      </svg>
    </div>
  );
  ...
  return (
    <div className="relative shrink-0">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col gap-px items-start relative">
        ...
        <Link1 />
        <Link2 />
        <div className="h-0 relative shrink-0 w-[154px]">
          <div className="absolute inset-[-0.5px_0]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 154 1">
              <path d="M0 0.5H154" id="Vector 1" stroke="var(--stroke-0, black)" />
            </svg>
          </div>
        </div>
        <Link3 />
...
function Container1() {
  return (
    <div className="content-stretch flex items-start mb-[-2px] pr-[-3.672px] relative shrink-0 w-full" data-name="Container">
      <Button />
      <EmailInput />
    </div>
  );
...
function Link6() {
  return (
    <div className="h-[16.5px] relative shrink-0 w-[50.672px]" data-name="Link">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <a className="-translate-y-1/2 absolute flex flex-col font-['Switzer:Medium',sans-serif] justify-center leading-[0] left-0 not-italic text-[12px] text-black top-[9px] tracking-[-0.0762px] whitespace-nowrap" href="https://www.behance.net/eunje_heo">
          <p className="cursor-pointer leading-[20.8px]">Behance</p>
        </a>
      </div>
    </div>
  );
...
function Link7() {
  return (
    <div className="h-[16.5px] relative shrink-0 w-[52.25px]" data-name="Link">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <a className="-translate-y-1/2 absolute flex flex-col font-['Switzer:Medium',sans-serif] justify-center leading-[0] left-0 not-italic text-[12px] text-black top-[9px] tracking-[-0.0762px] whitespace-nowrap" href="https://www.linkedin.com/in/eunje-heo-966364377/">
          <p className="cursor-pointer leading-[20.8px]">Linkedin</p>
        </a>
      </div>
    </div>
  );
...
function Container3() {
  return (
    <div className="content-stretch flex h-[192px] items-start justify-between relative shrink-0 w-full" data-name="Container">
      ...
      <div className="font-['Switzer:Medium',sans-serif] leading-[37px] not-italic relative shrink-0 text-[32px] text-black tracking-[-0.0762px] w-[1062px] whitespace-pre-wrap">
        <p className="mb-0">{`Eunje Heo is a graphic designer based in Seoul & London, specialising in brand experience. Through her background of visual and technology,        she creates distinctive experience for the project. `}</p>
        <p>
          <br aria-hidden="true" />
...
function Frame12() {
  return (
    <div className="-translate-x-1/2 -translate-y-1/2 absolute content-stretch flex flex-col gap-[6px] items-start left-[calc(50%-533px)] top-[calc(50%+144.5px)] w-[198px]">
...
function Frame13() {
  return (
    <div className="absolute content-stretch flex items-start left-[16px] top-[16px] w-[372px]">
      <Frame11 />
    </div>
  );
}
...
function Frame15() {
  return (
    <div className="-translate-x-1/2 -translate-y-1/2 absolute content-stretch flex flex-col gap-[6px] items-start left-[calc(50%-366.5px)] top-[calc(50%+133px)] w-[529px]">
      <div className="flex items-center justify-center relative shrink-0 w-full">
        <div className="-scale-y-100 flex-none w-full">
          <div className="flex flex-col font-['Switzer:Medium',sans-serif] justify-center leading-[0] not-italic relative text-[#bababa] text-[20px] tracking-[-0.0762px] w-full">
            <p className="leading-[20.8px]">Client: Hongik University</p>
          </div>
        </div>
      </div>
      <div className="flex items-center justify-center relative shrink-0 w-full">
        <div className="-scale-y-100 flex-none w-full">
          <div className="flex flex-col font-['Switzer:Medium',sans-serif] justify-center leading-[0] not-italic relative text-[#bababa] text-[20px] tracking-[-0.0762px] w-full">
            <p className="leading-[20px] whitespace-pre-wrap">
              {`2025 Hongik University Visual Communication `}
              <br aria-hidden="true" />
              Degree Show Space Design
            </p>
          </div>
        </div>
      </div>
